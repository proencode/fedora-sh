...
2.  Now is a good time to check that everything is working.
...
3.  Now, if you run the application, there will be a new join table called `car_owner` that is created between the car and owner tables.
