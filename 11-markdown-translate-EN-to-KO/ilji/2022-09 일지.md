...
`22-02-12` 하와이 한미일 외교장관 회의 블링컨 국무장관
- 해설:  외교장관 - 실무협상 한국 - 일본입장만 단속
...
`22-05-20` 미 바이든 대통령 방한, 문대통령 통화, 다음 일본, 중국 제외
...
`22-08-04` MBC > 국익 고려 펠로시 미팅 불발 / 유엔 사무총장 아시아 출장 발표
`22-08-07` 안보실2차장 전격 사퇴
`22-08-09` 칭따오 한중외교장관 회담 / 주한미대사, 미군사령관 윤과 비공개 간담회
`22-08-12` 유엔 사무총장 오찬 / 메드 마키 미 상원의원
`22-08-15` 광복절 기념사 - 담대한 구상
`22-08-17` 취임 100일 기념 기자회견 - 비핵화 약속시 패키지 투자발전 제안 하겠다
`22-08-17` 기자회견시 미국 CBS 구체안질문 약속대로 후속조치 예정
...
출처: 북미종전선언 10월초 가능성. BTS부산공연의 의미 조회수 10,119회2022. 9. 16. 세상돌아보기Gust&Thunder 구독자 3.53만명 https://www.youtube.com/watch?v=Tw4btMI_Ue0
