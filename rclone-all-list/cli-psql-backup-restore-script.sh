...
DB_VOLUME="/home/docker/pgsqlwiki" #-- db: volumes: /home/dicker/pgsqlwiki #-- DB 설치위치
DB_CONTAINER="wikijsdb" #-- db: container_name: wikijsdb > dncont #-- 데이터베이스 컨테이너
#--
...
services:
  ...
  db:
    ...
    environment:
      POSTGRES_DB: ${DB_NAME} #-- DB_NAME: wiki > wikidb #-- pgsql 데이터베이스 이름
#--
      POSTGRES_USER: ${DB_USER} #-- DB_USER: wikijs > imwiki #-- pgsql 사용자 이름
      POSTGRES_PASSWORD: wikijsrocks #-- wikiam9ho #-- wikijsrocks 비번
  ...
  wiki:
    ...
    environment:
      ...
      DB_PASS: wikijsrocks #-- wikiam9ho #-- wikijsrocks 비번
