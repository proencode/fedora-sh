...
$(cat ${log_keepass})
#--
>>>>>>> 9e980e30ec8653574c1591eca87efa634832db76
#----------
...
cat <<__EOF__
#--
#-- (3) INPUT: pswd (서버 비번 입력시 숫자 표시 안됨)
#--            ----
__EOF__
read -s svrPSWD #-- 호스트 접속시 비번, '-s' 타이핑하는 글자를 안보여준다.

cat <<__EOF__
#--
#-- (4) INPUT: 서버 디렉토리 [ ${svrDIR} ]
#--            -------------
__EOF__
read a
...
#--> ${svrDIR}
#--
#-- (5) 서버의 keepass 파일을 backup/ 으로 이동
