...
WordPress is one of the most widely used, powerful, and open content management systems (CMSs). Whether you're a si...
By Yannick Lefebvre
Mar 2022
420 pages
__EOF__
...
TitleName="WordPress Plugin Development Cookbook" #-- 책 제목
pubdate="2203a" #-- 책 발행일의 년월 + 당월 순서 알파벳 1 글자
gendate="230901" #-- 문서작성일 = 실행일
ShortDescription="By Yannick Lefebvre Mar 2022 420 pages" #-- 저자 발행일 등
...
declare -A  r1=([Code]="01.c1"  [Name]="Preparing a Local Development Environment"
	[Link]="https://subscription.packtpub.com/book/mobile/9781801810777/1")
declare -A  r2=([Code]="02.c2"  [Name]="Plugin Framework Basics"
	[Link]="https://subscription.packtpub.com/book/mobile/9781801810777/2")
declare -A  r3=([Code]="03.c3"  [Name]="User Settings and Administration Pages"
	[Link]="https://subscription.packtpub.com/book/mobile/9781801810777/3")
declare -A  r4=([Code]="04.c4"  [Name]="The Power of Custom Post Types"
	[Link]="https://subscription.packtpub.com/book/mobile/9781801810777/4")
declare -A  r5=([Code]="05.c5"  [Name]="Customizing Post and Page Editors"
	[Link]="https://subscription.packtpub.com/book/mobile/9781801810777/5")
declare -A  r6=([Code]="06.c6"  [Name]="Extending the Block Editor"
	[Link]="https://subscription.packtpub.com/book/mobile/9781801810777/6")
declare -A  r7=([Code]="07.c7"  [Name]="Accepting User Content Submissions"
	[Link]="https://subscription.packtpub.com/book/mobile/9781801810777/7")
declare -A  r8=([Code]="08.c8"  [Name]="Customizing User Data"
	[Link]="https://subscription.packtpub.com/book/mobile/9781801810777/8")
declare -A  r9=([Code]="09.c9"  [Name]="Leveraging JavaScript, jQuery, and AJAX Scripts"
	[Link]="https://subscription.packtpub.com/book/mobile/9781801810777/9")
declare -A r10=([Code]="10.c10" [Name]="Adding New Widgets to the WordPress Library"
	[Link]="https://subscription.packtpub.com/book/mobile/9781801810777/10")
declare -A r11=([Code]="11.c11" [Name]="Fetching, Caching, and Regularly Updating External Site Data"
	[Link]="https://subscription.packtpub.com/book/mobile/9781801810777/11")
declare -A r12=([Code]="12.c12" [Name]="Enabling Plugin Internationalization"
	[Link]="https://subscription.packtpub.com/book/mobile/9781801810777/12")
declare -A r13=([Code]="13.c13" [Name]="Distributing Your Plugin on WordPress.org"
	[Link]="https://subscription.packtpub.com/book/mobile/9781801810777/13")
declare -A r14=([Code]="14"     [Name]="Other Books You May Enjoy"
	[Link]="https://subscription.packtpub.com/book/mobile/9781801810777/14")
r_top=14 #--^^
