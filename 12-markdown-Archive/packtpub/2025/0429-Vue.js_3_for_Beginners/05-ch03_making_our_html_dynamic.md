...
In Accessing properties in a Vue.js SFC , we mentioned that prepending an attribute with : allows us to provide it dynamic value, and in the case of the class attribute, allows us to assign one or more dynamic classes.
