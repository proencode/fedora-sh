...
#
#
zzz = "wikidb_230927수-1227_vFedora38.sql.7z"
sql_name = wikidb_230927수-1227_vFedora38.sql.7z # 백업파일 이름만 꺼냄
sql_dir = wikidb_230927수-1227_vFedora38.sql.7z # 백업파일 이름을 빼고 나머지 디렉토리만 담음

🖍️ (6-5) 현재의 DB 를 백업하지 않으려면, 소문자 'n' 을 눌러 주세요."
[ n ]
(6-6) 백업을 시작하기전 위키 컨테이너를 멈춥니다.
      sudo docker ps -a ; sudo docker stop wikijsc ; sudo docker ps -a
CONTAINER ID   IMAGE                COMMAND                   CREATED       STATUS          PORTS                                                 NAMES
01261f5823b5   requarks/wiki:2      "docker-entrypoint.s…"   2 hours ago   Up 44 minutes   3443/tcp, 0.0.0.0:7700->3000/tcp, :::7700->3000/tcp   wikijsc
1afe152005cc   postgres:11-alpine   "docker-entrypoint.s…"   2 hours ago   Up 2 hours      5432/tcp                                              pgwikic
wikijsc
CONTAINER ID   IMAGE                COMMAND                   CREATED       STATUS                              PORTS      NAMES
01261f5823b5   requarks/wiki:2      "docker-entrypoint.s…"   2 hours ago   Exited (0) Less than a second ago              wikijsc
1afe152005cc   postgres:11-alpine   "docker-entrypoint.s…"   2 hours ago   Up 2 hours                          5432/tcp   pgwikic
# |
# |
# |
...
(6-8) 지정한 백업파일을 데이터베이스에 붓기 전에,
      현재 운영중인 DB 를 먼저 /home/docker/backup/pgwikic/2023-09 에 백업합니다.

      백업받은 .7z 파일에 지정해 줄 새로운 ===비밀번호=== 를 입력하세요.

      time sudo docker exec pgwikic pg_dumpall -U imwiki | 7za a -mx=9 -p -si /home/docker/backup/pgwikic/2023-09/last-pgwikic-230928_104952-vFedora38.sql.7z

7-Zip (a) [64] 16.02 : Copyright (c) 1999-2016 Igor Pavlov : 2016-05-21
p7zip Version 16.02 (locale=ko_KR.UTF-8,Utf16=on,HugeFiles=on,64 bits,1 CPU Intel(R) Core(TM) i5-6200U CPU @ 2.30GHz (406E3),ASM,AES-NI)

Creating archive: /home/docker/backup/pgwikic/2023-09/last-pgwikic-230928_104952-vFedora38.sql.7z
...
Archive size: 22818 bytes (23 KiB)
Everything is Ok

real	0m6.098s
user	0m0.183s
sys	0m0.051s
(6-9) 오늘 요일이름의 파일을 클라우드로 복사합니다.
      time rclone copy /home/docker/backup/pgwikic/2023-09/last-pgwikic-230928_104952-vFedora38.sql.7z tpn3mi:pgwikic/2023-09/

real	0m4.962s
user	0m0.189s
sys	0m0.085s
(6-11) 클라우드 폴더입니다.
       time rclone lsl tpn3mi:pgwikic/2023-09
      122 2023-09-27 14:45:57.000000000 last--230927_144543-vFedora38.sql.7z
    22818 2023-09-27 15:14:02.000000000 last-pgwikic-230927_151349-vFedora38.sql.7z
    22850 2023-09-28 09:24:27.000000000 last-pgwikic-230928_092415-vFedora38.sql.7z
    22818 2023-09-28 09:57:20.000000000 last-pgwikic-230928_095654-vFedora38.sql.7z
    22850 2023-09-28 10:02:21.000000000 last-pgwikic-230928_100205-vFedora38.sql.7z
    22818 2023-09-28 10:50:03.000000000 last-pgwikic-230928_104952-vFedora38.sql.7z
    23138 2023-09-27 11:56:38.000000000 wikidb_230927수-1149_vFedora38.sql.7z
    23138 2023-09-27 12:31:29.000000000 wikidb_230927수-1227_vFedora38.sql.7z
    22994 2023-09-27 14:40:56.000000000 wikidb_230927수-1440_vFedora38.sql.7z
    22994 2023-09-27 14:53:33.000000000 wikidb_230927수-1453_vFedora38.sql.7z
    23026 2023-09-28 09:17:33.000000000 wikidb_230928목-0916_vFedora38.sql.7z

real	0m3.618s
user	0m0.216s
sys	0m0.042s
(6-12) 기존의 데이터베이스를 삭제합니다.
       time sudo docker exec -it pgwikic dropdb -U imwiki wikidb

real	0m0.673s
user	0m0.021s
sys	0m0.018s
(6-13) 빈 데이터베이스를 새로 만듭니다.
       time sudo docker exec -it pgwikic createdb -U imwiki wikidb

real	0m7.612s
user	0m0.017s
sys	0m0.023s
(6-14) 지정한 백업파일을 데이터베이스에 다시 붓습니다. (RESTORE)
       백업할때 입력한 ----비밀번호---- 를 입력하세요.
       time 7za x -so wikidb_230927수-1227_vFedora38.sql.7z | sudo docker exec -i pgwikic psql -U imwiki wikidb
...
...
SET
You are now connected to database "postgres" as user "imwiki".
SET
...
SET
 set_config 
...
...
SET
ERROR:  database "wikidb" already exists
ALTER DATABASE
You are now connected to database "wikidb" as user "imwiki".
SET
...
SET
 set_config 
...
user	0m0.116s
sys	0m0.026s
(6-15) 멈췄던 위키 컨테이너를 다시 시작합니다.
       sudo docker start wikijsc ; sudo docker ps -a
wikijsc
CONTAINER ID   IMAGE                COMMAND                   CREATED       STATUS                  PORTS                                                 NAMES
01261f5823b5   requarks/wiki:2      "docker-entrypoint.s…"   2 hours ago   Up Less than a second   3443/tcp, 0.0.0.0:7700->3000/tcp, :::7700->3000/tcp   wikijsc
1afe152005cc   postgres:11-alpine   "docker-entrypoint.s…"   2 hours ago   Up 2 hours              5432/tcp                                              pgwikic
(6-16) 백업 작업이 끝났습니다.
🎶 (6-17) --------------------
```
...
#
#
(5-3) rclone lsf tpn3mi:
2023/
Welcome to MEGA.pdf
calls_sms/
wikipg/
(5-4) 위키 컨테이너를 중단합니다.
sudo docker ps -a ; sudo docker stop wikijsc
CONTAINER ID   IMAGE                COMMAND                   CREATED             STATUS          PORTS                                                 NAMES
93795e88e8a8   requarks/wiki:2      "docker-entrypoint.s…"   About an hour ago   Up 10 minutes   3443/tcp, 0.0.0.0:7700->3000/tcp, :::7700->3000/tcp   wikijsc
37b75b9b5c7e   postgres:11-alpine   "docker-entrypoint.s…"   About an hour ago   Up 13 minutes   5432/tcp                                              pgwikic
wikijsc
///
/// DB 백업
///
/// (5-5) wili.js 데이터베이스를 백업하기 위해서 아래에 ---비밀번호--- 를 입력하세요.
///
///       오늘 요일이름의 로컬 보관장소에 백업합니다.
time sudo docker exec pgwikic pg_dumpall -U imwiki | 7za a -p -si /home/docker/backup/pgwikic/2023-09/wikidb_230926화-1741_vFedora38.sql.7z
...
Creating archive: /home/docker/backup/pgwikic/2023-09/wikidb_230926화-1741_vFedora38.sql.7z
...
Files read from disk: 1
Archive size: 23186 bytes (23 KiB)
Everything is Ok

real	0m9.234s
user	0m0.106s
sys	0m0.036s
(5-6) 보관용 로컬 폴더입니다: ls -lR /home/docker/backup/pgwikic/2023-09
/home/docker/backup/pgwikic/2023-09:
합계 28
-rw-r--r--. 1 yosj yosj   122  9월 26일  17:30 wikidb_230926화-1728_vFedora38.sql.7z
-rw-r--r--. 1 yosj yosj 23186  9월 26일  17:41 wikidb_230926화-1741_vFedora38.sql.7z
(5-9) 위키 컨테이너를 다시 시작합니다: sudo docker start wikijsc ; sudo docker ps -a
wikijsc
CONTAINER ID   IMAGE                COMMAND                   CREATED             STATUS                  PORTS                                                 NAMES
93795e88e8a8   requarks/wiki:2      "docker-entrypoint.s…"   About an hour ago   Up Less than a second   3443/tcp, 0.0.0.0:7700->3000/tcp, :::7700->3000/tcp   wikijsc
37b75b9b5c7e   postgres:11-alpine   "docker-entrypoint.s…"   About an hour ago   Up 13 minutes           5432/tcp                                              pgwikic
🎶 (5-10) --------------------
17:41:14화230926 yosj@vFedora38 ~/git-projects/fedora-sh/12-markdown-Archive/ilji
ilji $ 
```
...
echo "(1-1) dnf 의 플러그인 코어를 받습니다: time sudo dnf -y install dnf-plugins-core (jj 0m35.843s; prn 0m20.586s; yscart 0m51.644s)"
...
echo "(1-5) docker-ce 를 받습니다: time sudo dnf makecache (jj 0m26.703s; prn 0m8.104s; yscat 0m13.500s)"
time sudo dnf makecache
echo "(1-6) time sudo dnf -y install docker-ce docker-ce-cli containerd.io (prn 0m21.065s; yscart 1m23.275s)"
...
echo "(1-7) 줄의 끝에 lines 1-24/24 (END) 가 나오면, 'Q' 를 눌러서 끝내야 합니다: sudo systemctl status docker"
...
echo "(1-10) docker-compose 를 설치합니다: time sudo dnf -y install docker-compose (jj 0m12.520s; prn 0m12.703s; yscart 0m47.560s)"
...
echo "(3-2) ${YML_NAME} 파일을 만듭니다: cat > ${YML_NAME} <<__EOF__"
...
echo "(3-3) ls -lR ${YML_NAME} ; cat ${YML_NAME}"
...
echo "(4-2) cd ${YML_DIR} "
cd ${YML_DIR}
echo "(4-3) 도커 컴포즈 설치: time sudo dnf -y install docker-compose (yscart 0m4.603s)"
time sudo dnf -y install docker-compose
echo "(4-4) 설치내역 확인: rpm -qi docker-compose"
rpm -qi docker-compose
echo "(4-5) sudo docker ps -a"
sudo docker ps -a
echo "(4-6) 도커 컴포즈 빌드: time sudo docker-compose pull ${WIKI_SERVICE} (prn 0m23.508s; yscart 0m57.622s)"
...
///       오늘 요일이름의 로컬 보관장소에 백업합니다.
__EOF__
    echo "time sudo docker exec ${DATABASE_CONTAINER} pg_dumpall -U ${DB_user_NAME} | 7za a -p -si ${LOCAL_Y2M2}/${current_backup_7z}"
    time sudo docker exec ${DATABASE_CONTAINER} pg_dumpall -U ${DB_user_NAME} | 7za a -p -si ${LOCAL_Y2M2}/${current_backup_7z}
...
__EOF__
    ...
    echo "qq----> n_equal_no_backup = [ ${n_equal_no_backup} ]"
    echo "qq----> y_equal_No_Backup = [ ${y_equal_No_Backup} ]"
