...
echo "(1-1) dnf 의 플러그인 코어를 받습니다: time sudo dnf -y install dnf-plugins-core"
...
echo "(1-5) docker-ce 를 받습니다: sudo dnf makecache"
sudo dnf makecache
...
echo "(1-10) docker-compose 를 설치합니다: time sudo dnf -y install docker-compose"
