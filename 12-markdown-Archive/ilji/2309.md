...
tempname="db_srv"
echo "----> (3-1) 데이터베이스 서비스 이름 : [ ${tempname} ]"
read a
if [ "x${a}" != "x" ]; then
    tempname=${a}
fi
...
echo "----> (3-5) wiki 데이터베이스 보관 디렉토리 : [ ${tempname} ]"
read a
if [ "x${a}" != "x" ]; then
    tempname=${a}
fi
...
tempname="pgwikic"
echo "----> (3-10) 데이터베이스 컨테이너 이름 : [ ${tempname} ]"
read a
if [ "x${a}" != "x" ]; then
    tempname=${a}
fi
...
tempname="imwiki"
echo "----> (3-12) 데이터베이스 유저 이름 : [ ${tempname} ]"
read a
if [ "x${a}" != "x" ]; then
    tempname=${a}
fi
...
tempname="wikipswd"
echo "----> (3-14) 데이터베이스 유저 비번 : [ ${tempname} ]"
read a
if [ "x${a}" != "x" ]; then
    tempname=${a}
fi
...
echo "----> (4-7) rclone 백업용 클라우드 이름 : [ ${tempname} ]"
read a
if [ "x${a}" != "x" ]; then
    tempname=${a}
fi
