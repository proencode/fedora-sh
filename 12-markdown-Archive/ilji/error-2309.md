...
1. mock moon landing https://www.cartoonstock.com/search?type=images&keyword=mock+moon+landing&page=20
1. 개발자와 직원+엔지니어가 오픈 소스 협업 개발에 참여해야 하는 이유 https://www.infoq.com/articles/developers-staff-plus-open-source/?utm_source=email&utm_medium=culture-methods&utm_campaign=newsletter&utm_content=09192023
1. GitHub에서 Copilot을 구축하는 데 사용되는 주요 프롬프트 엔지니어링 방식을 자세히 설명합니다. https://www.infoq.com/news/2023/07/copilot-prompt-engineering/?utm_source=email&utm_medium=editorial&utm_campaign=SpecialNL&utm_content=09212023&forceSponsorshipId=d57e72ac-38be-49e5-9055-1d97f65fde31

https://subscription.packtpub.com/book/web-development/9781837638338/pref

이 책의 개요
Svelte는 성능과 사용자 친화성에 초점을 맞춰 사용되는 인기 있는 프런트 엔드 프레임워크이며, 테스트 중심 개발(TDD)은 코드를 작성하기 전에 자동화된 테스트를 만드는 데 도움이 되는 강력한 접근 방식입니다. 이를 결합하면 최신 애플리케이션을 위한 효율적이고 유지 관리가 가능한 코드를 만들 수 있습니다. Svelte with Test-Driven Development는 Svelte 애플리케이션을 구축하고 유지 관리하기 위한 효과적인 자동화 테스트 방법을 배우는 데 도움이 됩니다. 책의 첫 번째 부분에서는 TDD 워크플로를 사용하여 SvelteKit 애플리케이션을 구축하는 방법을 단계별로 안내합니다. 효과적인 단위 테스트 사례를 작성하기 위한 주요 개념과 애플리케이션이 발전함에 따라 효율성을 유지하면서 애플리케이션 개발 속도를 높일 수 있는 견고하고 유지 관리 가능한 테스트 스위트를 개발하기 위한 실용적인 조언을 알아봅니다. 책의 다음 부분에서는 구성 요소 모의 사용 및 Cucumber.js 프레임워크를 사용한 BDD 스타일 테스트 작성과 같은 리팩토링 및 고급 테스트 기술에 중점을 둘 것입니다. 책의 마지막 부분에서는 인증, Svelte 스토어, 서비스 워커 등 복잡한 애플리케이션과 프레임워크 기능을 테스트하는 방법을 살펴보겠습니다. 이 책이 끝나면 이론 및 실무 지식을 활용하여 테스트 기반 Svelte 애플리케이션을 구축할 수 있는 준비를 갖추게 될 것입니다.


# 230924 일

1. 사랑의 불시착에 빠져서 100명 넘게 보게 한 찐팬 미국 가족 반응!  하이채드 Hi Chad 구독자 27.1만명 조회수 63만회  2년 전 https://www.youtube.com/watch?v=A0Muzcl16Zo
1. 워드프레스 호스팅 서버, AWS Lightsail로 홈페이지 만들기 온라인 건물 연구소 구독자 2.5천명 조회수 83회  2일 전 https://www.youtube.com/watch?v=ymiRKYmQBwY
1. 행정부의 오만방자한 법유린 행위를 사법부의 명철한 판단으로 처단해주길 바랍니다. https://docs.google.com/forms/d/e/1FAIpQLSdIC1vzbeDbnaVtExx36CNwnIQOBWD73Ya2sGsULRc_0u2Wmw/viewform
1. (급) 탄원서 너무 저조하답니다 ㅠㅠ 안하신분 꼭 해주세요 [28]2023-09-24 23:02초코초코픽 https://www.ddanzi.com/index.php?mid=free&document_srl=783079087&statusList=HOT%2CHOTBEST%2CHOTAC%2CHOTBESTAC
이재명 더불어민주당 대표 구속영장 실질 심사 탄원서입니다.  기한은 9월 25일(월) 오후 12시까지입니다.  목표는 100만 명입니다.  더불어민주당 당원 뿐만 아니라 모든 민주시민들이 함께 할 수 있게 널리 알려주십시오.  https://forms.gle/ypGYnjnJV2v37px58
1. 새날피셜 "내일 징계 논의" 있답니다👏👏👏 [24]2023-09-24 22:31보노보노🐙 > 청원취지 검찰정권의 무도한 패악질이 자행되는 가운데 당원의 80% 가까이 되는 지지자들이 선출하고 응원하고있는 당대표에 대한 체포동의안에 공공연히 가결을 표명한 해당행위자 5인 이상민, 김종민, 이원욱, 설훈, 조응천에 대한 징계를 분노로 청원합니다! (4,727) https://petitions.theminjoo.kr/23266004D5QHAK6
1. 급]이수진의원 발의/ 선박평형수 관리법 동의 좀 부탁/일본선박이 한국에서 오염수 못버리도록 [29]2023-09-24 21:15잼잼이모 국회청원]선박 평형수 관리법 일부개정법률안의 통과 및 조속한 시행 요구에 관한 청원 https://petitions.assembly.go.kr/status/onGoing/010B53173EFC099BE064B49691C1987F 일본선박이 우리나라와서 오염수 못 버리게 하는 법안입니다.5만명 빨리 채워야 합니다.  국민동의청원 홈페이지=>검색어<선박평형수>=>동의하기 /28일까지입니다./이수진의원 발의 https://petitions.assembly.go.kr/status/onGoing/010B53173EFC099BE064B49691C1987F
1. (((변희재, 당신이 잘 몰랐던 8가지 사실))) 변희재, 당신이 잘 몰랐던 8가지 사실 (유튜브 제목에서 한글이 풀어쓰기로 씌여져 있어서 조회가 되지 않는가?) https://www.youtube.com/watch?v=b9yzqH4c444 고양이뉴스 구독자 38.6만명 조회수 54만회  1년 전 국장님 인스타 : https://www.instagram.com/kimbbiyack


# 230923 토

1. 한국문화의 뿌리를 찾아 존 카터 코멜 김유경편역
1. 휴대폰 관리하는 방법~ 휴대폰 수명은 길게\~\~\~ 로보뷰글로벌아이넷 구독자 1.17천명 조회수 7.2만회  2개월 전 https://www.youtube.com/watch?v=-oq86t7LJAk
1. 월 1000만원 만들어준 꼭 읽어야 할 인생책 3권 추천해요 재개발은 진와이스 구독자 7.59만명 조회수 4.1만회  1년 전 https://www.youtube.com/watch?v=FU33gTvrRII
1. 구형폰(노트3)을 최신 안드로이드11로 탈바꿈 해보겠습니다. 업그레이드 가능.  복구천재 꼬마신발 구독자 11.3만명 조회수 125만회  1년 전 https://www.youtube.com/watch?v=TkZI3dJV0HE https://www.youtube.com/watch?v=TkZI3dJV0HE
1. 이걸 보시면 i를 왜 배우는지 알게 됩니다.  12 Math 구독자 17.8만명 조회수 58만회  10개월 전  수학 개념이야기 https://www.youtube.com/watch?v=UKD3ZmGLPt4
1. 중국반응│중국 여대생이 말하는 한국인과 중국인의 차이점│아시안게임 여학생│중국과 한국, 그리고 일본의 다른점 뉴스품에 안기자 구독자 1.46만명 조회수 3.4만회  4시간 전 https://www.youtube.com/watch?v=cQ3g1On2LPE
1. 독학으로 원어민처럼 말할 수 있게 된 영어공부법 5가지 (ft.성은님의 롤모델 미국언니) 양킹YangKING 구독자 34.4만명 조회수 24만회  3개월 전 https://www.youtube.com/watch?v=nMp0-Gzk7EM&t=71s
1.  bash와 zsh에서 hash map(dictionary, associative array) 사용하기 https://wiki.terzeron.com/OS_%EC%9D%BC%EB%B0%98_%EC%8B%9C%EC%8A%A4%ED%85%9C/Unix%EC%99%80_Linux_Tips/bash%EC%99%80_zsh%EC%97%90%EC%84%9C_hash_map_dictionary_associcative_array_%EC%82%AC%EC%9A%A9%ED%95%98%EA%B8%B0
1. [Bash Shell Script] 쉘 스크립트 파일 2개를 불러와 key-value 형태로 변환 (bash shell script key-value, bash shell script map) https://nirsa.tistory.com/345
1. bash 에서 키 값 사전
...
|:---:|:---|:---:|---:|:---:|:---:|:---:|---|:---:|:---:|
|:---:|:--- LEFT align|:---:|---: to the RIGHT|:---:|:---: sit in the CENTER|:---:|--- basic|:---:|:---:|
...
```
echo "시스템을 최신버전으로 유지하기 위해 다음을 실행합니다: sudo dnf -y update"
sudo dnf -y update
echo "🎶 --------------------"
```
...
echo "(1-1) sudo dnf -y install dnf-plugins-core"
sudo dnf -y install dnf-plugins-core
echo "🎶 (1-2) --------------------"
```
...
echo "(1-3) 지금 받으려는 docker-ce 가 있는 위치를 /etc/yum.repos.d/docker-ce.repo 리파지토리에 기록합니다."
sudo tee /etc/yum.repos.d/docker-ce.repo << __EOF__
[docker-ce-stable]
name=Docker CE Stable - \$basearch
baseurl=https://download.docker.com/linux/fedora/36/\$basearch/stable
...
echo "(1-7) sudo systemctl status docker"
sudo systemctl status docker
echo "(1-8) sudo docker version"
sudo docker version
echo "🎶 (1-9) --------------------"
```
...
echo "(1-10) docker-compose 를 설치합니다: sudo dnf -y install docker-compose"
sudo dnf -y install docker-compose
echo "(1-11) rpm -qi docker-compose"
rpm -qi docker-compose
echo "(1-12) sudo docker ps -a"
sudo docker ps -a
echo "🎶 (1-13) --------------------"
```
...
LOCAL_Y2M2=${DOCKER_DIR}/${DATABASE_CONTAINER}/${this_y4m2}
if [ ! -d ${LOCAL_Y2M2} ]; then
    echo "(6-2) ${LOCAL_Y2M2} 로컬 디렉토리를 만듭니다."
    mkdir -p ${LOCAL_Y2M2}
fi

echo "(6-3) rclone lsf ${CLOUD_NAME}"
rclone lsf ${CLOUD_NAME}

if [ "x${CLOUD_NAME} = "x" ]; then
    echo "(6-4) 클라우드 이름이 없어서 중단합니다."
else
    CLOUD_Y2M2=${DATABASE_CONTAINER}/${this_y4m2}
    echo "(6-5) 위키 도커를 중단합니다."
...
/// DB 백업
///
/// (6-6) wili.js 데이터베이스를 백업하기 위해서 아래에 ---비밀번호--- 를 입력하세요.
///
///       오늘 요일이름의 로컬 보관장소에 백업합니다.
__EOF__
    echo "sudo docker exec ${DATABASE_CONTAINER} pg_dumpall -U ${DB_USER} | 7za a -p -si ${LOCAL_Y2M2}/${current_backup_7z}"
    sudo docker exec ${DATABASE_CONTAINER} pg_dumpall -U ${DB_USER} | 7za a -p -si ${LOCAL_Y2M2}/${current_backup_7z}
    echo "(6-7) 보관용 로컬 폴더입니다: ls -lR ${LOCAL_Y2M2}"
    ls -lR ${LOCAL_Y2M2}
    # echo "#-- (5-12) 오늘 요일이름의 파일을 클라우드로 복사합니다: sudo /usr/bin/rclone copy ${LOCAL_Y2M2}/${current_backup_7z} ${CLOUD_NAME}:${CLOUD_Y2M2}/"
    # sudo /usr/bin/rclone copy ${LOCAL_Y2M2}/${DB_sql7z} ${CLOUD_NAME}:${CLOUD_Y2M2}/
    # echo "#-- (5-13) 클라우드 폴더입니다. /usr/bin/rclone lsl ${CLOUD_NAME}:${CLOUD_Y2M2}"
    # /usr/bin/rclone lsl ${CLOUD_NAME}:${CLOUD_Y2M2}
    echo "(6-8) 위키 도커를 다시 시작합니다: sudo docker start ${WIKI_CONTAINER} ; sudo docker ps -a"
...
WIKIJS_SH="${HOME}/bin/variables_wikijs.sh"
echo "(7-1) \$(cat ${WIKIJS_SH}) #-- wiki.js 의 bash 변수 초기값을 읽어들입니다."
$(cat ${WIKIJS_SH})
...
if [ ! -d ${LOCAL_Y2M2} ]; then
    echo "#-- (7-2) ${LOCAL_Y2M2} 로컬 디렉토리를 만듭니다: mkdir -p ${LOCAL_Y2M2}"
    mkdir -p ${LOCAL_Y2M2}
fi
...
if [ "x${zzz}" = "x" ] || [ ! -f "${zzz}" ]; then
    #-- ----> 리스토어 파일이 없으면 여기서 끝냄.
    cat <<__EOF__
||| (7-3) ls -lR ${LOCAL_FOLDER} #--- 백업 디렉토리 내용
$(ls -lR ${LOCAL_FOLDER})
|||
||| (7-4) 지정한 (리스토어 할) ${zzz} 파일이 존재하지 않습니다.
|||
||| 리스토어 할 파일 이름이 "${LOCAL_Y2M2}" 디렉토리에 있는 " last-${DB_CONTAINER}-230908금-1431-vFedora38.sql.7z " 인 경우:
||| 
||| zzz="${LOCAL_Y2M2}/last-${DB_CONTAINER}-230908금-1431-vFedora38.sql.7z"
|||
||| (복구하려는 파일 이름을 담은 환경 변수의 이름이 'zzz' 임.)
|||
||| 이와 같이 Bash Terminal 에서 선언하고 나서, 이 스크립트를 다시 실행해야 합니다.
||| 
🎶 (7-5) ${zzz} 파일이 없으므로 작업을 중단합니다.
__EOF__
    #-- <---- 리스토어 파일이 없으면 여기서 끝냄.
else
    #-- ----> 리스토어 할 .7z 파일이 있다.
...
🖍️ (7-6) 현재의 DB 를 백업하지 않으려면, 소문자 'n' 을 눌러 주세요."
__EOF__
    read n_equal_no_backup ; echo "${uuu}"
    echo "[ ${n_equal_no_backup} ]"

    #-- --> '백업 받기 전' 위키 컨테이너 정지
    cat <<__EOF__
#-- (7-7) 백업을 시작하기전 위키 컨테이너를 멈춥니다.
#-- sudo docker ps -a ; sudo docker stop ${WIKI_CONTAINER} ; sudo docker ps -a
__EOF__
    sudo docker ps -a ; sudo docker stop ${WIKI_CONTAINER} ; sudo docker ps -a
    #-- <-- '백업 받기 전' 위키 컨테이너 정지

    if [ "x$n_equal_no_backup" = 'xn' ]; then
...
# |
🖍️ (7-8) 백업 하지 않고 = 'y' Enter:
__EOF__
        read y_equal_No_Backup ; echo "${uuu}"
        echo "[ ${y_equal_No_Backup} ]"

        if [ "x$y_equal_No_Backup" = 'xy' ]; then
            n_equal_no_backup="n"
        fi
        #-- ----> 현재의 DB 를 백업하지 않는다 선택.
    fi
    ...
    if [ "x$n_equal_No_Backup" != 'xn' ]; then
        ...
        current_backup_7z="${LOCAL_Y2M2}/last-${DB_CONTAINER}-$(date +%y%m%d_%H%M%S)-$(uname -n).sql.7z"
        cat <<__EOF__
#== (7-9) 지정한 백업파일을 데이터베이스에 붓기 전에,
#== 현재 운영중인 DB 를 먼저 ${LOCAL_Y2M2} 에 백업합니다.
#==
#== 백업받은 .7z 파일에 지정해 줄 새로운 ===비밀번호=== 를 입력하세요.
#==
#== sudo docker exec ${DB_CONTAINER} pg_dumpall -U ${DB_USER} | 7za a -mx=9 -p -si ${current_backup_7z}
__EOF__
        sudo docker exec ${DB_CONTAINER} pg_dumpall -U ${DB_USER} | 7za a -mx=9 -p -si ${current_backup_7z}
        cat <<__EOF__
#== (7-10) 오늘 요일이름의 파일을 클라우드로 복사합니다.
#== sudo /usr/bin/rclone copy ${current_backup_7z} ${CLOUD_NAME}:${CLOUD_Y2M2}/
__EOF__
        sudo /usr/bin/rclone copy ${current_backup_7z} ${CLOUD_NAME}:${CLOUD_Y2M2}/
        cat <<__EOF__
#== (7-11) 클라우드 폴더입니다.
