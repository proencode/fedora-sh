...
echo "#-- sudo docker ps -a #-- 현재 도커 작업"
sudo docker ps -a
echo "#-- sudo docker stop wikijs wikijsdb #-- 도커 정지"
sudo docker stop wikijs wikijsdb
echo "#-- sudo docker rm wikijs wikijsdb #-- 도커 삭제"
sudo docker rm wikijs wikijsdb
echo "#-- sudo docker ps -a #-- 현재 도커 작업"
sudo docker ps -a
...
echo "#---- ls -R /home/docker"
ls -R /home/docker
echo "#----> /home/docker 디렉토리를 삭제합니다. press Enter:"
read a
sudo rmdir -p /home/docker
...
echo "#------------"
echo "#------------ bash ~/bin/31-last-12-sql.7z--RESTORE-to--wikijs-DB.sh ${up_file}"
