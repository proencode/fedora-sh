...
do
	echo "----> time 7za a -mx=${val} -ptest Big_programs-mx${val}-220905.7z [LW]*"
	time 7za a -mx=${val} -ptest Big_programs-mx${val}-220905.7z [LW]*
	echo "----> time 7za a -mx=${val} -ptest Download-bada-mx${val}-220905.7z bada"
	time 7za a -mx=${val} -ptest Download-bada-mx${val}-220905.7z bada
done
