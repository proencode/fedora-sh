...
cat_and_run "sudo dnf -y install kernel-headers kernel-devel dkms elfutils-libelf-devel qt5-qtx11extras" "1:"
...
cat_and_run "sudo dnf -y search virtualbox" "3: Import VirtualBox GPG Key ----> Press “y” when prompted."
